...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="p-4 border-b-2 last:border-none border-slate-700 dark:bg-black dark:text-white">
      <div className="flex justify-between py-3.5 px-2.5 gap-14 flex-col md:flex-row">
        ...
        <div className="md:w-[70%] w-full flex flex-col gap-5">
          <h1 className="text-xl font-[600] text-slate-700 dark:text-white">
            {item.title}
          </h1>
